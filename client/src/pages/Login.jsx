...
const Login = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenyly max-sm:flex-col backdrop-blur-2xl'>
      {/*---------left---------*/}
            ...
            )}
            {
              currState==="Sign up" && isDataSubmitted &&(
                <textarea onChange={(e)=>setBio(e.target.value)} value={bio}
                 rows={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2-indigo-500' 
