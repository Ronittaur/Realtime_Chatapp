...
const ProfilePage = () => {
  ...
  const handleSubmit = async(e)=>{
    ...
    if(!selectedImg){
      ...
      console.log('Profile update result (no image):', result);
      navigate('/');
      return;
    }
    ...
    reader.onload = async()=>{
      ...
      console.log('Profile update result (with image):', result);
      navigate('/');
    }
    ...
    justify-center'>
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          placeholder='Write Profile bio' required className="p-2 border border-gray-500 rounded-md focus:
