...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      pb-6'>
        ...
        <div className='absolute bottom-0 left-0 flex items-center gap-3 p-3'>
          <div className='flex-1 flex items-center bg-gray-100/22 px-3 rounded-full'>
    ...
    <div className='flex flex-col items-center justify-center h-full gap-4 bg-white/10 text-white max-md:hidden'>
